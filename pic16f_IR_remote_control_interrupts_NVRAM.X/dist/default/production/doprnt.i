...
{
 va_list ap;
# 507 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
 char c;
 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  flag = 0;
# 609 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
...
# 654 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  ...
  case 0:
   goto alldone;
# 769 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
dostring:
   ...
   continue;
# 803 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  case 'c':
# 818 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  ...
  default:
   ...
   len = 1;
   goto dostring;
# 836 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  case 'u':
   flag |= 0xC0;
   break;
...
# 1324 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
   for(c = 1 ; c != sizeof dpowers/sizeof dpowers[0] ; c++)
    if(val < dpowers[c])
     break;
# 1400 "C:\\Program Files (x86)\\Microchip\\xc8\\v2.00\\pic\\sources\\c90\\common\\doprnt.c"
  if(width > c)
   width -= c;
  else
   width = 0;
